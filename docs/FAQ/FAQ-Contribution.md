...
If you want to read more about fees here is a nice explanation: [What are the fees for the CoinJoin](https://docs.wasabiwallet.io/FAQ/FAQ-UseWasabi.md#what-are-the-fees-for-the-coinjoin).
:::
