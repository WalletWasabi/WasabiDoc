...
In order to do this, you [must run a full node](/using-wasabi/BitcoinFullNode.md) and verify the entire timechain.
...
If you are [running your own node](/using-wasabi/BitcoinFullNode.md), then you can pull this block directly from the timechain that you have fully verified your self.
