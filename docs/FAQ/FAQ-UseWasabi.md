...
If you want to also secure your address labels, the anonset of your coins and additional metadata, then you can do a digital backup.
...
This also contains unencrypted the extended public key, the public keys, and the address labels, meaning that it completely links all the coins, both pre and post mix, with clear proof.
...
:::tip
The wallet file backup is sensitive, in terms of privacy, but not critical in terms of loss of funds (if a good password was used when generating the wallet).
