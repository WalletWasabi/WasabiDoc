...
Partially, Wasabi supports sending to Taproot (bech32m) address format, receiving Taproot outputs from a coinjoin, and receiving change from a normal transaction to a Taproot address.
