...
Wasabi was unveiled in 2018 at the Building on Bitcoin conference by Adam Ficsor. At the time, Wasabi was essentially HiddenWallet rebranded and rewritten from scratch with some new features.
Key dates:
...
For the complete history of Wasabi you can see [this presentation by Adam Ficsor](https://www.youtube.com/watch?v=XORDEX-RrAI&t=17m01s). Adam's speech starts at 17m 01s
@[youtube](XORDEX-RrAI)
...
- Security: Some people prefer open source software because they consider it more secure and stable than proprietary software.
...
- Stability: Many users prefer open source software to proprietary software for important, long-term projects.
...
ZeroLink is first to offer protections against all the different ways a user's privacy can be breached.
