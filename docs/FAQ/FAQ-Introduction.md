...
Since Wasabi version [2.8.0](https://github.com/WalletWasabi/WalletWasabi/releases/tag/v2.8.0), Wasabi fetchers the block filters from the Bitcoin P2P network.
