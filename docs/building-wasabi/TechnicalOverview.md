...
These pages show the wallets that can be used to send to and receive from Wasabi: [https://en.bitcoin.it/wiki/Bech32_adoption#Software_Wallets](https://en.bitcoin.it/wiki/Bech32_adoption#Software_Wallets)
