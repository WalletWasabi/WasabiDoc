...
The RPC server does NOT support batch requests or TLS communications (because it is not supported on Linux and on Mac: [https://github.com/dotnet/corefx/issues/14691](https://github.com/dotnet/corefx/issues/14691)).
