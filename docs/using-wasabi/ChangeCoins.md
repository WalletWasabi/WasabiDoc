...
When you have a KYC red-shield `anonymity set 1` UTXO and you register it for a CoinJoin round, you will afterwards receive 1 green-shield `anonymity set 'x'` UTXO, and one red-shield `anonymity set 1` change UTXO.
...
The larger UTXO will have a green-shield that indicates the size of the anonymity set achieved in that CoinJoin round.
...
Since your identity was already known in the red-shield/anonset 1 UTXO, it is now linked with certainty to your coinjoined UTXO.
